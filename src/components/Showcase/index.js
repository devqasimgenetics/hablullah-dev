...
const Showcase = ({ children = '', imgUrl = '/showcase/default-showcase.png' }) => {
    return (
        <section
            ...
            className="bg-gradient-to-r from-blue-900 to-blue-700 bg-no-repeat flex items-center justify-center bg-center bg-cover text-white md:min-h-80 mb-10 md:mb-16">
