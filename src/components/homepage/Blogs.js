          ...
          <div>
            <article className="overflow-hidden">
              ...
              <div className="w-full py-5 md:py-6">
                ...
                <span className="font-semibold text-[#0267B1] text-sm md:text-base hover:text-black transition-all mt-auto">Read More</span>
              </div>
            </article>
          </div>
          <div>
            {blogs.map((blog, index) => (
              <article key={index} className="flex overflow-hidden mb-6">
                <img
                  src={blog?.image}
                  alt={blog?.title}
                ...
                <div className="w-full px-4">
                  ...
                  <button className="font-semibold text-[#0267B1] text-sm md:text-base hover:text-black transition-all">
                    Read More
                  </button>
                </div>
              </article>
